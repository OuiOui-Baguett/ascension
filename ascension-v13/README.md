...
**Une vraie salle** : arène de 33 m de diamètre, mur et plafond, colonnes, lustre, moquette à
médaillon, bar garni, coins salon, cordons de velours — plus le décor propre à chaque étage
(lianes, bulles, coulées de lave, hublots sur la Terre, miroirs et escaliers impossibles).
Coût mesuré : ~200 appels de rendu et ~18 000 triangles par image, soit trois fois rien pour un mobile.
