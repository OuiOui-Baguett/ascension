...
const SPOTS = { Roue: [-7.79, -1.34], Pierres: [-5.88, -5.27], Totem: [2.18, -7.59], Fourmis: [5.88, -5.27], Capybaras: [7.79, -1.34] };
...
async function goTo(fragment) {
  ...
  for (const [wx, wz, near] of [[null, 1, 0.6], [tx, 1, 0.6], [tx, tz, 2.4]]) {
    for (let i = 0; i < 14; i++) {
      const p = await pos();
