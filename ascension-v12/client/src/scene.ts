...
export const MACHINE_SPOTS = [
  new THREE.Vector3(-7.79, 0, -1.34),
  new THREE.Vector3(-5.88, 0, -5.27),
  new THREE.Vector3(-2.18, 0, -7.59),
  new THREE.Vector3(2.18, 0, -7.59),
  new THREE.Vector3(5.88, 0, -5.27),
  new THREE.Vector3(7.79, 0, -1.34),
];
export const SHOP_POS = new THREE.Vector3(-6.6, 0, 3.6);
const YAWS = [0.50, 0.30, 0.10, -0.10, -0.30, -0.50];
...
function tick(now: number) {
  ...
  if (me) {
    ...
    if (len > .05) {
      ...
      const solids = [...MACHINE_SPOTS.map(s => ({ p: s, r: 2.05 })), { p: SHOP_POS, r: 1.7 }];
