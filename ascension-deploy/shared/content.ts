...
export type Archetype = 'WHEEL' | 'CRASH' | 'SLOTS' | 'HILO';
...
export const FLOORS: FloorDef[] = [
  ...
  },
  {
    ...
    machines: [
      wheel('roulette_marees', 'Roulette des Marées', 'Une perle portée par les courants.'),
      ...
      hilo('cartes_corsaire', 'Les Cartes du Corsaire', 'Le corsaire ne bluffe jamais. Toi, si.'),
    ],
  },
  {
    ...
    machines: [
      ...
      crash('geyser', 'Le Geyser', 'Lâche la valve avant l’explosion.'),
      slots('forge_lingots', 'La Forge à Lingots', 'Trois frappes, un lingot ou des cendres.', ['🪨', '🔥', '⚒️', '💀', '👑']),
      hilo('cartes_demon', 'Les Cartes du Démon', 'Le démon compte les cartes. Et il triche.'),
    ],
  },
  {
    ...
    machines: [
      wheel('roulette_grav', 'Roulette Gravitationnelle', 'La bille orbite autour d’un puits de gravité.'),
      crash('convoyeur', 'Convoyeur de Drones', 'Rappelle le drone avant l’impact.'),
      slots('slots_holo', 'Slots Holographiques', 'Trois hologrammes. Alignement quantique souhaité.', ['⭐', '🛰️', '👾', '🚀', '👑']),
  ...
  },
  {
    ...
    machines: [
      ...
      slots('jackpot_paradoxe', 'Le Jackpot du Paradoxe', 'Trois couronnes et la tour s’incline.', ['🌀', '🎲', '💎', '🪙', '👑']),
      hilo('cartes_destin', 'Les Cartes du Destin', 'La dernière carte a déjà été tirée. Laquelle ?'),
    ],
  },
];
