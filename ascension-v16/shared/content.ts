...
// ---- Radio du casino : chaque station est composée EN DIRECT par le client
// (oscillateurs Web Audio). Aucun morceau, aucun fichier : rien d'emprunté à personne.
export interface StationDef { id: string; name: string; tag: string; icon: string }
export const STATIONS: StationDef[] = [
  { id: 'auto',      name: 'Ambiance de l’étage', tag: 'La nappe du décor, sans rythme', icon: '🌫️' },
  { id: 'tamtam',    name: 'Tam-Tam Club',        tag: 'Marimba, congas, basse ronde',   icon: '🪘' },
  { id: 'deepblue',  name: 'Deep Blue',           tag: 'Nappes lentes et sonar',         icon: '🌊' },
  { id: 'forge',     name: 'Forge',               tag: 'Kick au sol, basse saturée',     icon: '🔨' },
  { id: 'orbital',   name: 'Orbital',             tag: 'Arpèges synthwave',              icon: '🛰️' },
  { id: 'minuit',    name: 'Après-Minuit',        tag: 'Lounge jazzy, balais, septièmes', icon: '🍸' },
  { id: 'off',       name: 'Coupée',              tag: 'Silence complet',                icon: '🔇' },
];
export const stationAt = (id: string) => STATIONS.find(s => s.id === id) ?? STATIONS[0];
